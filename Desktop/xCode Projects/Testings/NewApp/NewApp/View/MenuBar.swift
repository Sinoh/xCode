...
class MenuBar: UIView, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    // Next two funcs creates cell for te navigation tab to be used to create home, trending, subscription, and account
...
class MenuCell: BaseCell {
    ...
    let imageView: UIImageView = {
        ...
        iv.tintColor = UIColor.rgb(red: 91, green: 14, blue: 13) // set tint color of the four cells
        return iv
    }()
